    ...
    <section className="relative min-h-[424px] overflow-hidden bg-[#1A1A1A]">
      ...
      <div className="relative mx-auto flex min-h-[424px] max-w-[1440px] items-center px-[80px] py-[76px]">
        <div className="max-w-[1060px]">
          <p className="text-[11px] font-semibold tracking-[0.26em] text-[var(--ae-accent)]">
            ADVERTISE
          </p>
          ...
          <p className="mt-7 max-w-[800px] text-[17px] leading-[1.62] text-white/78 md:text-[18px]">
            Connect your brand with architects, designers, engineers, contractors,
            manufacturers, developers, and other AEC professionals through premium
            advertising opportunities designed specifically for the architecture,
