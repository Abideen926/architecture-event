...
import { advertisingPackages } from "@/lib/architecture-events/advertise/advertise-data";
          ...
          {advertisingPackages.map((pkg) => (
            ...
            >
              ...
              <div className="mt-auto pt-8">
                ...
                <button
                  type="button"
                  className={`inline-flex min-h-[37px] w-full items-center justify-center rounded-[11px] border px-4 py-[8px] text-center text-[13px] font-medium leading-[1.15] transition-colors ${
