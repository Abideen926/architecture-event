...
const discoverLinks = [
  { href: appRoutes.architectureEvents.events, label: "Events" },
  { href: appRoutes.architectureEvents.events, label: "Brands" },
  { href: appRoutes.architectureEvents.events, label: "Venues" },
  { href: appRoutes.architectureEvents.events, label: "Resources" },
  { href: appRoutes.architectureEvents.events, label: "Event archive" },
];
...
const companyLinks = [
  ...
  { href: appRoutes.architectureEvents.contact, label: "Contact" },
