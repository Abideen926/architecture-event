...
export function SubmitEventSuccessStep({
  ...
  return (
    <div className="mt-[30px] rounded-[20px] border border-ae-border bg-mainbackground px-[44px] py-[66px] text-center">
      <span className="inline-flex h-[56px] w-[56px] items-center justify-center rounded-full bg-foreground text-white">
      ...
      {selectedPackage === "featured" ? (
        <p className="mx-auto mt-[18px] max-w-[52ch] text-[14.5px] leading-[1.7] text-ae-muted">
