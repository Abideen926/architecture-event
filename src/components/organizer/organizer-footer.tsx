export function OrganizerFooter() {
  return (
    <footer className="bg-[#1E1E1E] text-white/72">
      <div className="mx-auto flex w-full max-w-[1600px] flex-col gap-5 px-[18px] py-11 md:px-7 lg:flex-row lg:items-center lg:justify-between lg:px-16">
        ...
        <p className="text-[13.5px]">&copy; 2026 Architecture Events. All rights reserved.</p>
      </div>
    </footer>
  );
}
